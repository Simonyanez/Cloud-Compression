...
% 2. Estándares de Compresión para Point Clouds
%    2.1. MPEG G-PCC (incluye octree como subsección técnica)
%    2.2. MPEG V-PCC
%    2.3. Otros estándares (Draco, JPEG Pleno)
\section{Estándares de Compresión para Nubes de Puntos}
    El desarrollo de estándares de compresión para nubes de puntos ha tomado relevancia debido al gran interés de empresas móviles y  diversos inversores dedicados a la adquisición de datos en formato de nubes de puntos. Ahora bien, existen diversos contextos de implementación para este tipo de datos, donde cada uno propone un desafío diferente. Estos están separados en tres categorías: 1. nubes de puntos estáticas; 2. nubes de puntos dinámicas que varían en el tiempo; y 3. nubes de puntos adquiridas dinámicamente. \cite{emerging_mpeg} 
    \\
    Además para la evaluación existen tres tipos de modelos de testeo para las distintas categorías L-PCC, S-PCC y V-PCC. Donde el primero son datos LiDAR que se caracterizan por su adquisición dinámica y muestreo irregular, el segundo son superficies con alto muestreo aproximando una superficie 3D, y finalmente videos que corresponden a información dinámica.
    \subsection{MPEG G-PCC}
        Esta codificación es la combinación de las estrategias para afrontar L-PCC y S-PCC para la compresión de geometría (Geometry Based Point Cloud Compression). Esta mixtura de ambos algoritmos se conforma por la codificación por octree de L-PCC y la voxelización con la determinación de bloques de S-PCC. Además utilizando Region Adaptive Hierarchical Transform, se comprimen los atributos a través de transformadas espaciales jerárquicas y codificación entrópica.
        \subsubsection{Codificación por Octree}
    ...
    \subsection{MPEG V-PCC}
        En este caso, este estandar es el utilizado para videos y busca explotar la correlación entres cada nube de puntos. A diferencia del anterior, usa herramientas auxiliares para generar muestras 2D que puedan analizarse a través de algoritmos clásicos de compresión de video. Al generar de forma estratégica un conjunto de imágenes se puede almacenar la geometría y textura de la nube de puntos.
    \subsection{JPEG Pleno}
    \subsection{Draco}

% 3. Métodos de Compresión de Atributos
%    3.1. Transformadas en el contexto de G-PCC
%    3.2. Graph Transform (tu sección actual)
%    3.3. Transformadas Paramétricas (LST-ICE)

\section{Métodos de Copmresión de Atributos}
    \subsection{Transformadas en el contexto de G-PCC}
    \subsection{Graph Transform}\label{sec:pcac_geometric}
    ...
    \subsection{Transformadas paramétricas}

% 4. Enfoques de Deep Learning
\section{Enfoques de Deep Learning}

% 5. Codificadores de Entropía (RL-GR que ya tienes)
...
% 6. Análisis Comparativo y Justificación Metodológica
% 7. Brechas y Oportunidades de Investigación
