...
\subsection{Transformada Gráfica de Fourier}\label{subsec: gft}
    ...
    Entendiendo esto, podemos hacer reconstrucciones parciales de la señal, perdiendo parte de su información, pero mostrando su comportamiento general y relevante relevante para analizarla e interpretarla. Para toda señal podremos construir un conjunto $M \subset \{1,2,...,N\}$ tal que:
